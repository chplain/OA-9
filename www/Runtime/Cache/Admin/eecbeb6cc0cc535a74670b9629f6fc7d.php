...
<div id="main-content">
  ...
  <div class="breadcrumb">
    ...
    <div>
      <a href="<?php echo u('dev/newdevlist');?>">新产品开发计划</a>
      <span class="divider">/</span>
    </div>
    <div><?php echo ($info['id']?'编辑':'新增'); ?>新产品开发计划</div>
  </div>


    
  <div class="newly">
    <form action="/oa/www/admin/dev/new_dev_add/id/119.html" method="post" enctype="multipart/form-data" class="form-horizontal">
    <!-- <form action="/oa/www/admin/dev/new_dev_add/id/119.html" method="post" enctype="multipart/form-data" class="form-vertical"> -->
      <div class="edit_title">产品信息</div>
      <div class="edit_items">
        <label class="edit_label">计划编号：</label>
        <div class="edit_info">
          <input readonly placeholder="系统自动生成" type="text" value='<?php echo ($newproducts["plan_code"]); ?>'/>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <select name="product_name" class="selectpicker" data-width="172" title="请选择" data-size="6" data-live-search="true" data-live-search-placeholder="Search">
            <?php if(is_array($products)): $i = 0; $__LIST__ = $products;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($newproducts['product_name'] == $vo['product_name']): ?><option selected value='<?php echo ($vo["product_name"]); ?>'><?php echo ($vo["product_name"]); ?></option>
                <?php else: ?>
                <option value='<?php echo ($vo["product_name"]); ?>'><?php echo ($vo["product_name"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
          </select>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <select name="product_type" class="selectpicker" data-width="172" title="请选择" data-size="6">
            <?php if($newproducts['product_type'] == '1'): ?><option selected value="1">标准版</option>
              <option value="2">新产品</option>
              <option value="3">集团版</option>
            <?php elseif($newproducts['product_type'] == '2'): ?>
              <option value="1">标准版</option>
              <option selected value="2">新产品</option>
              <option  value="3">集团版</option>
            <?php elseif($newproducts['product_type'] == '3'): ?>
              <option value="1">标准版</option>
              <option value="2">新产品</option>
            ...
            <?php else: ?>
              <option value="1">标准版</option>
              <option value="2">新产品</option>
              <option value="3">集团版</option><?php endif; ?>
          </select>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <input  type="text" name="version" value='<?php echo ($newproducts["version"]); ?>'/>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <div class="date form_datetime">
            ...
            <input type="text" class="date" name="start_time" value='<?php echo ($newproducts["start_time"]); ?>' placeholder="选择日期" readonly>
          </div>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <div class="date form_datetime">
            <span class="add-on"><i class="icon-th glyphicon glyphicon-calendar"></i></span>
            <input type="text" class="date" name="end_time" value='<?php echo ($newproducts["end_time"]); ?>' placeholder="选择日期" readonly>
          </div>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <input type="text" name="manday" value='<?php echo ($newproducts["manday"]); ?>'/>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <div class="date form_datetime">
            <span class="add-on"><i class="icon-th glyphicon glyphicon-calendar"></i></span>
            <input type="text" class="date" name="ac_time" value='<?php echo ($newproducts["ac_time"]); ?>' placeholder="选择日期" readonly>
          </div>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <select id="project_id" name="dev_role" class="selectpicker" data-width="172" title="请选择" data-size="6">
            <?php if(is_array($devs)): $i = 0; $__LIST__ = $devs;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($newproducts['dev_role'] == $vo['nickname']): ?><option selected name="dev_role" value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option>
                <?php else: ?>
                <option name="dev_role" value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
          </select>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <select id="project_id" name="product_charge" class="selectpicker" data-width="172" title="请选择" data-size="6">
            <?php if(is_array($prods)): $i = 0; $__LIST__ = $prods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($newproducts['product_charge'] == $vo['nickname']): ?><option selected  value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option>
              <?php else: ?>
                <option  value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endif; endforeach; endif; else: echo "" ;endif; ?>
          </select>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <textarea name="describe"><?php echo ($newproducts["describe"]); ?></textarea>
        </div>
      </div>
      <div class="edit_title">开发计划</div>
      <div class="edit-box fee">
        <?php if($phases != ''): if(is_array($phases)): $i = 0; $__LIST__ = $phases;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($i % 2 );++$i;?><div class="cell">
              <div class="edit_items">
                <label class="edit_label" style="color:red;">开发阶段：</label>
                <div class="edit_info">
                  <div class="edit_info">
                    <select name="data[<?php echo ($key); ?>][product_jd]" class="selectpicker product_jd" data-width="172" title="请选择" data-size="6">
                      <option value="产品设计"
              ...
              <div class="edit_items">
                ...
                <div class="edit_info">
                  <div class="date form_datetime">
                    <span class="add-on"><i class="icon-th glyphicon glyphicon-calendar"></i></span>
                    <input type="text" class="date" name="data[<?php echo ($key); ?>][stime]" placeholder="选择日期" readonly value='<?php echo ($vo1["stime"]); ?>' value="<?php echo ($vo1["etime"]); ?>">
                  </div>
                  <span class="spacing">至</span>
                  <div class="date form_datetime">
                    <span class="add-on"><i class="icon-th glyphicon glyphicon-calendar"></i></span>
                    <input type="text" class="date" name="data[<?php echo ($key); ?>][etime]" placeholder="选择日期" readonly value="<?php echo ($vo1["etime"]); ?>">
                  </div>
                </div>
              </div>
              <div class="edit_items">
                ...
                <div class="edit_info">
                  <input type="text" name="data[<?php echo ($key); ?>][manday]" value="<?php echo ($vo1["manday"]); ?>">
                </div>
              </div>
              <div class="edit_items">
                <label class="edit_label">预计费用：</label>
                <div class="edit_info">
                  <input type="text" name="data[<?php echo ($key); ?>][PhasesFee]" value="<?php echo ($vo1["PhasesFee"]); ?>">
                </div>
              </div>
              <div class="edit_items">
                <label class="edit_label">负责人：</label>
                <div class="edit_info">
                  <select name="data[<?php echo ($key); ?>][charge_person]" class="selectpicker charg_slt" data-width="172" title="请选择" data-size="6">
                    <?php if(is_array($dddd)): foreach($dddd as $k=>$vo): if($vo1['charge_person'] == $vo['nickname']): ?><option name="dev_role" selected value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option>
                        <?php else: ?>
                        <option name="dev_role" value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endif; endforeach; endif; ?>
                  </select>
                </div>
              </div>
              <div class="edit_items">
                ...
                <div class="edit_info">
                  <textarea name="data[<?php echo ($key); ?>][remark]"><?php echo ($vo1["remark"]); ?></textarea>
                </div>
              </div>
              <?php if($key == 0): ?><div class="edit_btn">
                  <span class="add-btn" data-index="<?php echo ($key+1); ?>" data-sign="charge">+</span>
                </div>
                <?php else: ?>
                <div class="edit_btn">
                  <span class="add-btn" data-index="<?php echo ($key+1); ?>" data-sign="charge">+</span>
                  <span class="del-btn" data-index="<?php echo ($key+1); ?>" data-sign="charge">-</span>
                </div><?php endif; ?>
            ...
            <div class="edit_items">
              ...
              <div class="edit_info">
                <select name="data[0][charge_person]" class="selectpicker charg_slt" data-width="172" title="请选择" data-size="6">
                  <?php if(is_array($devs1)): $i = 0; $__LIST__ = $devs1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name="dev_role" value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
              </div>
            </div>
            <div class="edit_items">
      ...
      <div class="edit-box uploadWrap">
        <div class="cell">
          <div class="edit_items">
            ...
            <div class="edit_info">
              <?php if($newproducts["accessory"] == ''): ?><input type="file" name="accessory" >
              <?php else: ?>
                <a target="view_window" href='<?php echo ($newproducts["accessory"]); ?>' class="updown">附件下载</a>
      ...
      <div class="edit_btn action_btn">
        <input type="hidden" name="id" value="<?php echo ((isset($newproducts["id"]) && ($newproducts["id"] !== ""))?($newproducts["id"]):''); ?>">
...
<script type="text/javascript">
      ...
      <div class="edit_items">
        ...
        <div class="edit_info">
          <select name="data[{{index}}][charge_person]" class="selectpicker charg_slt" data-width="172" title="请选择" data-size="6">
            <?php if(is_array($dddd)): $i = 0; $__LIST__ = $dddd;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option name="dev_role" value="<?php echo ($vo["nickname"]); ?>"><?php echo ($vo["nickname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
          </select>
        </div>
      </div>
      <div class="edit_items">
  ...
  <script type="text/javascript">
    ...
    $(function () {
      $('.side-sub-menu').find('a[href="<?php echo U('dev/newdevlist');?>"]').closest('li').addClass('current');
      ...
      $('.fee').on('change', 'select.product_jd', function () {
        ...
        // Ajax提交数据
        $.ajax({
          url: "<?php echo U('Dev/getChargeperson');?>",    // 提交到controller的url路径
          type: "post",    // 提交方式
