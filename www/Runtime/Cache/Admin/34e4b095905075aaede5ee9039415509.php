...
<div id="main-content">
  ...
  <div id="main" class="main">
    ...
    <div>
        <button class="btn" id="action_add" url="<?php echo U('product/add');?>">新 增</button>
...
<table class="">
    ...
    <tbody>
        <?php if(is_array($product)): $i = 0; $__LIST__ = $product;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["product_code"]); ?></td>
            <td class=""><?php echo ($vo["product_name"]); ?></td>
            <td class=""><?php echo ($vo["product_type"]); ?></td>
            <td class=""><?php echo ($vo["product_versions"]); ?></td>
            <td class=""><?php echo ($vo["charge"]); ?></td>
            <td class=""><?php echo ($vo["link_phone"]); ?></td>
            <?php if($vo["status"] == 1): ?><td class="">正常</td>
            <?php elseif($vo["status"] == 2): ?>
                <td class="">开发中</td>
            <?php elseif($vo["status"] == 3): ?>
                <td class="">作废</td><?php endif; ?>
            <td class=""><?php echo ($vo["creator"]); ?></td>
            <td class=""><?php echo ($vo["create_time"]); ?></td>
            <td class=""><?php echo ($vo["uptor"]); ?></td>
