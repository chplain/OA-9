...
<html lang="en">
    <head>
        <meta charset="UTF-8">
        <title>欢迎您登录OA管理平台</title>
        <link rel="stylesheet" type="text/css" href="/OA/www/Public/Admin/css/login.css" media="all">
            ...
            <div class="login-body">
                <div class="login-main pr">
                    <form action="<?php echo U('login');?>" method="post" class="login-form">
                        <h3 class="welcome">
                        <i class="login-logo" style="width: 60px;height: 60px;"></i>OA管理平台</h3>
