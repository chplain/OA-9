...
<div id="main-content">
  ...
  <div class="search_box">
    <div class="items">
      <span>项目|商业名称：</span>
      <input type="text" name="project_name" class="search-input" value="<?php echo I('project_name');?>" placeholder="">
    </div>
    <div class="items">
      <span>实施人员：</span>
      <input type="text" name="executor" class="search-input" value="<?php echo I('executor');?>" placeholder="">
    </div>
    <div class="items">

    </div>
    <div class="items">
      <a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('execut_log');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('add_execut_log');?>">新 增</button>
      <!-- <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('delete_transfer',array('status'=>-1));?>">删 除</button> -->
    </div>
  </div>
  <!-- 数据列表 -->
  <div class="data-table">
    <table class="">
      ...
      <tbody>
      <?php if($excutes != ''): if(is_array($excutes)): $i = 0; $__LIST__ = $excutes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            <td><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>"/></td>
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["rd_time"]); ?>"><?php echo ($vo["rd_time"]); ?></td>
            ...
            <td class="">第<?php echo ($vo["phases"]); ?>阶段</td>
            <td class=""><?php echo ($vo["executor"]); ?></td>
            <td class=""><?php echo ($vo["manday"]); ?></td>
            <td class=""><?php echo ($vo["s_time"]); ?></td>
            <td class=""><?php echo ($vo["e_time"]); ?></td>
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["content"]); ?>"><?php echo ($vo["content"]); ?></td>
            <td class=""><?php echo ($vo["project_fee"]); ?></td>
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["next_plan"]); ?>"><?php echo ($vo["next_plan"]); ?></td>
