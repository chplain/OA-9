...
<div id="main-content">
  ...
  <div class="breadcrumb">
    <span>您的位置:</span>
    <div>
      <a href="<?php echo u('contract/intention');?>">开发管理</a>
      <span class="divider">/</span>
    </div>
    <div>
      <a href="<?php echo u('index');?>">项目版本号管理</a>
      <span class="divider">/</span>
    </div>
    <div><?php echo ($customer['id']?'编辑':'新增'); ?>版本号</div>
  </div>


    
  <div class="newly">
    <form action="/oa/www/admin/dev/version_add.html" method="post" class="form-vertical">
      
      <div class="edit_items">
        <label class="edit_label">项目名称</label>
        <div class="edit_info">
          <!-- <input type="text" name="customer" value="<?php echo ($customer["customer"]); ?>" placeholder="请输入名字"> -->
      ...
      <div class="edit_items">
        <label class="edit_label">项目版本号</label>
        <div class="edit_info">
          <input type="text" name="version" value="<?php echo ($customer["version"]); ?>" placeholder="版本号">
        </div>
      </div>
      
      <div class="edit_btn">
        <input type="hidden" name="id" value="<?php echo ((isset($customer["id"]) && ($customer["id"] !== ""))?($customer["id"]):''); ?>">
...
<script type="text/javascript">
  ...
  <script type="text/javascript">
    $(function () {
      //导航高亮
      $('.side-sub-menu').find('a[href=\"<?php echo U('Dev/version');?>\"]').closest('li').addClass('current');
    })
  </script>
