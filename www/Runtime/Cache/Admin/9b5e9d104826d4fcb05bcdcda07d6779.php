...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items">
      ...
      <div class="drop-down">
        <span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>">
          <?php if(get_status_title1($status) == ''): ?>所有
            <?php else: ?>
            <?php echo get_status_title1($status); endif; ?>
        </span>
    ...
    <div class="items">
      <a class="sch-btn" href="javascript:void (0);" id="search" url="<?php echo U('official');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('contract_sure',array('status'=>-1));?>">合同生效</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('contract_termination',array('status'=>-1));?>">终 止</button>
    </div>
  </div>
  ...
  <div class="data-table">
    <table class="">
      ...
      <?php if($contracts != ''): if(is_array($contracts)): $i = 0; $__LIST__ = $contracts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["Contract_unit"]); ?>"><?php echo ($vo["Contract_unit"]); ?></td>
            <td class=""><?php echo ($vo["contract_code"]); ?></td>
            <td>
              <?php if($vo["status"] == 2): ?>新增
            ...
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["project_name"]); ?>"><?php echo ($vo["project_name"]); ?></td>
            ...
            <td class="" style="max-width: 90px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["updata_time"]); ?>"><?php echo ($vo["updata_time"]); ?></td>
            <td class="">
              <a href="<?php echo U('Contract/official_mess?id='.$vo['id']);?>">详情</a>
            </td>
            <!--  <td>
