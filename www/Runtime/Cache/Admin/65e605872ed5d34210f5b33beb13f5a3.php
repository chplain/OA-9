  ...
  <div id="main" class="main">
	...
	<div class="cf">
		<div class="fl">
            ...
            <button class="btn ajax-post confirm" url="<?php echo U('User/deleteUser',array('method'=>'deleteUser'));?>" target-form="ids">删 除</button>
        </div>
...
<script type="text/javascript">
  +function () {
	...
	<script src="/OA/www/Public/static/thinkbox/jquery.thinkbox.js"></script>
