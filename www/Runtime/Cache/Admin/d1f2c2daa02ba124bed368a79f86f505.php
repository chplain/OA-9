...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items">
      <a class="sch-btn" href="javascript:void (0);" id="search" url="<?php echo U('pj_complete');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('add_project_complete');?>">新 增</button>
  ...
  <div class="data-table">
    <table>
      ...
      <tbody>
      <?php if($completes != ''): if(is_array($completes)): $i = 0; $__LIST__ = $completes;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
          <td><input class="ids" type="checkbox" name="ids[]" value="<?php echo ($vo["id"]); ?>"/></td>
          <td><?php echo ($vo["complete_code"]); ?></td>
          <td><?php echo ($vo["project_name"]); ?></td>
          <td><?php echo ($vo["plan_code"]); ?></td>
          <td>第<?php echo ($vo["phases"]); ?>阶段</td>
          <td>
            <?php if($vo["IsDelay"] == 0): ?>否
              <?php elseif($vo["IsDelay"] == 1): ?>
              是<?php endif; ?>
          </td>
          <td><?php echo ($vo["DelayWhy"]); ?></td>
          <td>
            <a target="view_window" href='<?php echo ($vo["receipt_url"]); ?>'>验收单</a>
          </td>
          <td><?php echo ($vo["prompt_url"]); ?></td>
          <td><?php echo ($vo["prompt_id"]); ?></td>
          <td><?php echo ($vo["executor"]); ?></td>
          <td><?php echo ($vo["ac_rtime"]); ?></td>
          <td><?php echo ($vo["rd_time"]); ?></td>
