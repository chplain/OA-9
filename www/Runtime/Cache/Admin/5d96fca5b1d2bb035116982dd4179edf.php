...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items">
      ...
      <div class="drop-down">
        <span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>">
          <?php if(state_text3($status) == ''): ?>所有
            <?php else: ?>
            <?php echo state_text3($status); endif; ?>
        </span>
    ...
    <div class="items">
      <a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('work_log');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('work_log_add');?>">新 增</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('complete',array('status'=>-1));?>">完 成</button>
    </div>
  </div>
  <!-- 数据列表 -->
  <div class="data-table">
    <table class="">
      ...
      <tbody>
      <?php if($work_log != ''): if(is_array($work_log)): $i = 0; $__LIST__ = $work_log;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["plan_code"]); ?>第<?php echo ($vo["phases"]); ?>阶段 </td>
            <td class="">计划<?php echo ($vo["wphases"]); ?>                  </td>
            <td class=""><?php echo ($vo["remark"]); ?>                      </td>
            <td class=""><?php echo ($vo["executor"]); ?>                    </td>
            <?php if($vo["status"] == 1): ?><td class="">进行中                      </td>
    
            <?php else: ?>
              <td class="">已完成                      </td><?php endif; ?>
            <!-- <td class=""><?php echo ($vo["fee"]); ?>                         </td> -->
            <td class=""><?php echo ($vo["next_plan"]); ?>                   </td>
            <td class=""><?php echo ($vo["create_person"]); ?>               </td>
            <td class="">
              <a href="<?php echo U('Tech/work_log_add?id='.$vo['id']);?>">详情</a>
            </td>
