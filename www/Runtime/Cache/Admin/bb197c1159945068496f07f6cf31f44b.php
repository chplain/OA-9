...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items">
      ...
      <div class="drop-down">
        <span id="sch-sort-txt" class="sort-txt" data="<?php echo ($status); ?>">
          <?php if(state_text4($status) == ''): ?>所有
            <?php else: ?>
            <?php echo state_text4($status); endif; ?>
        </span>
    ...
    <div class="items">
      <a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('workplan');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('workPlan_add');?>">新 增</button>
      <!-- <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('tech_sure',array('status'=>-1));?>">生 效</button> -->
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('wp_breake',array('status'=>-1));?>">作 废</button>
    </div>
  </div>
  ...
  <div class="data-table">
    <table class="">
      ...
      <tbody>
      <?php if($plans != ''): if(is_array($plans)): $i = 0; $__LIST__ = $plans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["stime"]); ?>至<?php echo ($vo["etime"]); ?></td>

            <td class=""><?php echo ($vo["products"]); ?></td>
            <td class="" style="max-width: 150px;overflow: hidden;white-space: nowrap;text-overflow: ellipsis;" title="<?php echo ($vo["remark"]); ?>"><?php echo ($vo["remark"]); ?></td>
            ...
            <td class="">
              <a href="<?php echo U('Tech/workplanMess?id='.$vo['id']);?>">详情</a>
            </td>
