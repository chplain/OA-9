...
<div id="main-content">
  ...
  <div class="breadcrumb">
    <span>您的位置:</span>
    <div>
      <a href="<?php echo u('withdraw/index');?>">财务管理</a>
  ...
  <div class="search_box">
    ...
    <div class="items">
      <span>交付编号：</span>
      <input type="text" name="transfer_code" class="search-input" value="<?php echo I('transfer_code');?>">
    </div>
    <div class="items">
      <a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('invoice');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('invoice_add');?>">新 增</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('doinvoice',array('status'=>-1));?>">开 票</button>
    </div>
  </div>
  ...
  <div class="data-table">
    <table>
      ...
      <tbody>
      <?php if($invoices != ''): if(is_array($invoices)): $i = 0; $__LIST__ = $invoices;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td><?php echo ($vo["contract_fee"]); ?></td>
            <td><?php echo ($vo["downpayment"]); ?></td>
            <td><?php echo ($vo["complete_code"]); ?></td>

            <td>
              <?php if($vo["phases"] == 0): ?>首付款
                <?php else: ?>
                第<?php echo ($vo["phases"]); ?>阶段<?php endif; ?>
            </td>
            <td><?php echo ($vo["PhasesFee"]); ?></td>
            <td>
              <?php if($vo["Isinvoice"] == 0): ?>否
                <?php elseif($vo["Isinvoice"] == 1): ?>
                是<?php endif; ?>
            </td>
            <td><?php echo ($vo["updata_person"]); ?></td>
            <td><?php echo ($vo["updata_time"]); ?></td>
