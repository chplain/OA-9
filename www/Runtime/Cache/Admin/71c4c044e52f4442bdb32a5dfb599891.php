...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('add');?>">新 增</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('tech_sure',array('status'=>-1));?>">生 效</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('termination',array('status'=>-1));?>">终 止</button>
    </div>
  </div>
  ...
  <div class="data-table">
    <table class="">
      ...
      <?php if($plans != ''): if(is_array($plans)): $i = 0; $__LIST__ = $plans;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["project_money"]); ?></td>
            <td class=""><?php echo ($vo["province"]); ?></td>
            <td class=""><?php echo ($vo["sales_charge_person"]); ?></td>
            <td class=""><?php echo ($vo["tech_charge_person"]); ?></td>
            ...
            <td class="">
              <a href="<?php echo U('Tech/plan_mess?id='.$vo['id']);?>">详情</a>
            </td>
