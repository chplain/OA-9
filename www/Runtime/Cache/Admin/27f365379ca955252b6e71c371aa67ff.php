...
<div id="main-content">
  ...
  <div class="search_box">
    ...
    <div class="items">
      <span>实施人员：</span>
      <input type="text" name="executor" class="search-input" value="<?php echo I('executor');?>">
    </div>
    <div class="items">
      <span>催款单号：</span>
      <input type="text" name="prompt_id" class="search-input" value="<?php echo I('prompt_id');?>">
    </div>
    <div class="items">
      <a class="sch-btn" href="javascript:void(0);" id="search" url="<?php echo U('payreminder');?>"><i class="btn-search"></i></a>
    </div>
    <div class="items action_btn_box">
      <button class="btn" id="action_add" url="<?php echo U('payreminder_add');?>">新 增</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('delete_transfer',array('status'=>-1));?>">删 除</button>
      <button class="btn ajax-post confirm" target-form="ids" url="<?php echo U('cus_sure',array('status'=>-1));?>">客户确认</button>
    </div>
  </div>
  <!-- 数据列表 -->
  <div class="data-table">
    <table class="">
      ...
      <tbody>
      <?php if($payreminders != ''): if(is_array($payreminders)): $i = 0; $__LIST__ = $payreminders;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
            ...
            <td class=""><?php echo ($vo["prompt_result"]); ?></td>
            ...
            <td class=""><?php echo ($vo["rtime"]); ?></td>
            <td class=""><?php echo ($vo["rmoney"]); ?></td>
