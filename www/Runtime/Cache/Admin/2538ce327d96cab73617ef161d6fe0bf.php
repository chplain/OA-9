...
<div id="main-content">
  ...
  <div class="newly">
    <form action="/oa/www/admin/dev/dev_delivery_mess/id/43.html" method="post" class="form-vertical">
      <div class="edit_items">
        <label class="edit_label">交付编号</label>
        <div class="edit_info">
          <input type="text" readonly placeholder="(系统自动生成)" value="<?php echo ($delivery["delivery_code"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">交付类型</label>
        <div class="edit_info">
          <input type="text" readonly placeholder="(系统自动生成)" value="<?php echo ($delivery["delivery_type"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">项目名称</label>
        <div class="edit_info">
          <input type="text" readonly placeholder="(系统自动生成)" value="<?php echo ($delivery["project_name"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">项目类型</label>
        <div class="edit_info">
          <input type="text" id="project_type" readonly name="project_type" value="<?php echo ($delivery["project_type"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">项目地区</label>
        <div class="edit_info">
          <input type="text" readonly id="province" name="province" value="<?php echo ($delivery["province"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">合同编号</label>
        <div class="edit_info">
          <input type="text" readonly placeholder="(系统自动生成)" value="<?php echo ($delivery["delivery_code"]); ?>" value="<?php echo ($delivery["contract_code"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">采购产品</label>
        <div class="edit_info">
          <input type="text"  id="project_productlist" name="project_productlist" value="<?php echo ($delivery["project_productlist"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">交付产品</label>
        <div class="edit_info">
          <input type="text" readonly placeholder="(系统自动生成)" value="<?php echo ($delivery["deliver_product"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">实施负责人</label>
        <div class="edit_info">
          <input type="text"  id="TechRole" name="tech_role" value="<?php echo ($delivery["tech_role"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">交付版本号</label>
        <div class="edit_info">
          <input type="text" name="deliver_version" value="<?php echo ($delivery["deliver_version"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <div class="date form_datetime">
            ...
            <input type="text" class="date" name="del_date" placeholder="选择日期" readonly value="<?php echo ($delivery["del_date"]); ?>">
          </div>
        </div>
      </div>
      <div class="edit_items">
        ...
        <div class="edit_info">
          <input type="text" name="dev_role" value="<?php echo ($delivery["dev_role"]); ?>">
        </div>
      </div>
      <div class="edit_items">
        <label class="edit_label">情况说明</label>
        <div class="edit_info">
          <textarea name="discribe"><?php echo ($delivery["describe"]); ?></textarea>
        </div>
      </div>
      <div class="edit_btn">
